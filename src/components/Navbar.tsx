...
const NAV_ITEMS = [
  { name: "Home", href: "/" },
  { name: "Clothing Alterations & Repairs", href: "/alterations-and-repairs" },
    ...
    <header className="bg-yellow-300 py-4 px-6 shadow-md fixed w-screen z-50">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="text-base font-semibold text-gray-900">
          ...
          <Image src="/logo.png" alt="townsville alteration logo" width={150} height={60}/>
        </Link>
        ...
        <div className="flex items-center space-x-4">
          <Instagram className="hidden lg:block text-gray-700 cursor-pointer" size={20} />
          <Facebook className="hidden lg:block text-gray-700 cursor-pointer" size={20} />
          <User className="text-gray-700 cursor-pointer" size={20} />
          <ShoppingBag className="text-gray-700 cursor-pointer" size={20} />
        </div>
      </div>
