    ...
    return (
        <section className="bg-[#f2f2e5] py-12 px-6 md:px-12 lg:px-24 text-gray-800 text-center">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto mb-6">
                ...
                are delivered to your door in less than 24 hours, anywhere in Australia.
            </p>
            ...
            <div className="max-w-3xl mx-auto text-gray-700 space-y-4">
                ...
                <p><strong>STEP 1:</strong> Choose a Style - Browse our collection of suits and tuxedos.</p>
                <p><strong>STEP 2:</strong> Get the Perfect Fit - Your suit is yours for 7 or 14 days and comes with accidental damage insurance. We send you two jacket and trouser sizes—so you always have the perfect fit.</p>
