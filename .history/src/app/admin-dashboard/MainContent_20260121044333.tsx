    ...
    return (
      <div className="space-y-6">
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 rounded-2xl shadow-sm border border-blue-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-blue-700">Gallery Images</p>
                <p className="text-2xl sm:text-3xl font-bold text-blue-900 mt-1 sm:mt-2">{stats.gallery}</p>
              </div>
              <div className="text-2xl sm:text-3xl">🖼️</div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 sm:p-6 rounded-2xl shadow-sm border border-purple-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-700">Featured Images</p>
                <p className="text-2xl sm:text-3xl font-bold text-purple-900 mt-1 sm:mt-2">{stats.featured}</p>
              </div>
              <div className="text-2xl sm:text-3xl">⭐</div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 sm:p-6 rounded-2xl shadow-sm border border-green-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-700">Suits Collection</p>
                <p className="text-2xl sm:text-3xl font-bold text-green-900 mt-1 sm:mt-2">{stats.suits}</p>
              </div>
              <div className="text-2xl sm:text-3xl">👔</div>
            </div>
          </div>
          <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-4 sm:p-6 rounded-2xl shadow-sm border border-pink-200">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-pink-700">Wedding Gowns</p>
                <p className="text-2xl sm:text-3xl font-bold text-pink-900 mt-1 sm:mt-2">{stats.weddingGowns}</p>
              </div>
              <div className="text-2xl sm:text-3xl">👰</div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <button 
              ...
              className="p-3 sm:p-4 rounded-xl border-2 border-gray-200 hover:border-yellow-400 hover:bg-yellow-50 transition-colors text-left"
            >
