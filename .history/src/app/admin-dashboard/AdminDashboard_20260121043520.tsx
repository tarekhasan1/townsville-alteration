  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className={`fixed lg:sticky top-0 left-0 h-full z-50 transform transition-transform duration-300 ease-in-out
        ...
        <main className="flex-1 w-full lg:ml-64 min-h-screen">
          <div className="p-4 md:p-6 lg:p-8 max-w-7xl mx-auto">
            ...
            <button
              ...
              className="lg:hidden fixed top-4 left-4 z-30 p-2 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow"
            >
