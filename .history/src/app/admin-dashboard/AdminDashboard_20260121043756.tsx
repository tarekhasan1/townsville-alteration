...
export default function AdminDashboard() {
  ...
  const handleSectionChange = (section: CollectionType | 'dashboard' | 'upload') => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
      ...
      <div className="flex">
        {/* Sidebar - Use the state from parent */}
        <div className={`
        ...
        <main className={`flex-1 min-h-screen transition-all duration-300 ${
          ...
          <div className="p-4 md:p-6 lg:p-8 max-w-[calc(100vw-1rem)] lg:max-w-[calc(100vw-256px)] xl:max-w-7xl mx-auto">
            {/* Mobile Toggle Button - Remove duplicate from Sidebar since we control it here */}
            <button
              onClick={() => setSidebarOpen(true)}
              className="lg:hidden fixed top-4 left-4 z-30 p-2.5 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow"
            >
