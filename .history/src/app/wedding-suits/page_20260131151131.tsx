...
export default function WeddingSuitsPage() {
  return (
    <main className='pt-[80px]'>
      {/* Hero Section - FIXED: Removed horizontal space */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 md:py-24 w-full">
        {/* Remove mx-auto and add w-full to ensure full width */}
