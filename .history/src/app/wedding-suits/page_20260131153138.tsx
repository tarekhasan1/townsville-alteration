...
export default function WeddingSuitsPage() {
  return (
    <main className='pt-[80px]'>
      {/* Hero Section - FIXED: Full width blue background */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 md:py-24 w-full overflow-hidden">
