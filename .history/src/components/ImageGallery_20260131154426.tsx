...
export default function ImageGallery({
    ...
    return (
      <section className="bg-gradient-to-br from-white to-yellow-50 py-16 px-6 md:px-12 lg:px-24 text-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto"> {/* Added wrapper with max-width */}
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">{title}</h2>
            <div className="border-b border-[2px] border-yellow-300 mb-8"></div> {/* Removed w-[80vw] */}
  ...
  return (
    <section className="bg-gradient-to-br from-white to-yellow-50 py-16 px-6 md:px-12 lg:px-24 text-gray-800">
      <div className="max-w-7xl mx-auto">
        {/* Header section with proper width constraints */}
        <div className="text-center max-w-4xl mx-auto mb-12"> {/* Changed to mb-12 and added max-width */}
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">{title}</h2>
          <div className="border-b border-[2px] border-yellow-300 mb-8"></div> {/* Removed w-[80vw] */}
