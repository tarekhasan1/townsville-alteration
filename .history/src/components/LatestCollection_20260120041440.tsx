...
export default function LatestCollection() {
  ...
  return (
    <section id="latest-collection" className="bg-gradient-to-br from-white to-yellow-50 py-16 px-6 md:px-12 lg:px-24 text-gray-800">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-12">
          Explore our freshest styles and most popular looks—handpicked for your standout moments.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {paginatedImages.map((src, index) => (
            ...
            >
              <Image
                src={src}
                alt={`Latest formal wear and suit collection image ${index + 1} - Townsville Alterations`}
                width={500}
                height={600}
        ...
        <div className="mt-10">
          <Link
            href="/gallery"
            aria-label="Explore full gallery of Townsville Alterations and Formal Wear"
